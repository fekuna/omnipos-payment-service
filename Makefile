...
# Default target
help:
	@echo "OmniPOS Payment Service Makefile"
	@echo ""
	...
	@echo "  migrate_create  - Create a new migration file (usage: make migrate_create name=description)"
